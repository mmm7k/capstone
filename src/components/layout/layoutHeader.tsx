...
export default function LayoutHeader() {
  ...
  return (
    ...
    >
      ...
      {/* 햄버거 메뉴 */}
      {menuOpen && (
        <div className="fixed top-0 left-0 w-full h-full bg-[#151825] z-10 flex flex-col items-center justify-center space-y-6 text-white">
          <Link href="/" onClick={closeMenu}>
            <div
              className={`text-xl ${
                pathname === '/'
                  ? 'text-[#00C395] border-b-[3px] border-[#00C395] pb-1'
                  : ''
              }`}
            >
              Home
          ...
          <Link href="/countries/france" onClick={closeMenu}>
            <div
              className={`text-xl ${
                pathname.startsWith('/countries')
                  ? 'text-[#00C395] border-b-[3px] border-[#00C395] pb-1'
          ...
          <Link href="/planner" onClick={closeMenu}>
            <div
              className={`text-xl ${
                pathname === '/planner'
                  ? 'text-[#00C395] border-b-[3px] border-[#00C395] pb-1'
